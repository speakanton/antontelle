...
namespace DateTimeParser
{
    ...
    public static class DateTimeEnglishParser
    {
        #region  Fields
        ...
        public static DateTime ParseRelative(DateTime baseTime, string dateToParse)
        {
            ...
            if (match.Success)
            {
                ...
                if (allDayNames.Contains(unit, StringComparer.CurrentCultureIgnoreCase))
                {
                    return thisWithUnits.Replace(dateString,
                                                 dateBase.This(DateUnit.Week).Next(StringToDayOfWeek(unit)).ToString());
                }
                if (allMonthNames.Contains(unit, StringComparer.CurrentCultureIgnoreCase))
                {
                    return thisWithUnits.Replace(dateString,
                                                 DateTime.ParseExact(unit,
                                                                     new[] {"MMMM", "MMM"},
                                                                     dateTimeFormat,
                                                                     DateTimeStyles.NoCurrentDateDefault).ToString());
                }
            }
        ...
        private static DateTime ParseString(string dateString, DateTime dateBase)
        {
            return CheckForActualDateTime(dateString) ??
        ...
        /// <param name="dateString"></param>
        /// <returns></returns>
        private static DateTime? CheckForActualDateTime(string dateString)
        {
        ...
        /// <param name="dateBase"></param>
        /// <returns></returns>
        private static DateTime? CheckNextLastIndicator(string dateString, DateTime dateBase)
        {
        ...
        /// <param name="dateBase"></param>
        /// <returns></returns>
        private static DateTime? CheckUnitsFromMatch(string dateString, DateTime dateBase)
        {
        ...
        /// <param name="dateBase"></param>
        /// <returns></returns>
        private static DateTime? CheckEntireStringIsDay(string dateString, DateTime dateBase)
        {
        ...
        /// <param name="dateBase"></param>
        /// <returns></returns>
        private static DateTime? CheckFirstWordIsDay(string dateString, DateTime dateBase)
        {
        ...
        /// <param name="dateBase"></param>
        /// <returns></returns>
        private static DateTime? CheckEntireStringIsMonth(string dateString, DateTime dateBase)
        {
            DateTime monthDate;
        ...
        /// <param name="dateBase"></param>
        /// <returns></returns>
        private static DateTime? CheckFirstWordIsMonth(string dateString, DateTime dateBase)
        {
        ...
        private static DateTime? CheckSpecificDayNames(string dateString, DateTime dateBase)
        {
            switch (dateString)
            {
                case "tomorrow":
        ...
        /// <param name="dateBase"></param>
        /// <returns></returns>
        private static DateTime? CheckDayNumeric(string dateString, DateTime dateBase)
        {
            int date;
